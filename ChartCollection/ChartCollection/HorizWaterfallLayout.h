...
@class HorizWaterfallLayout;

@protocol HorWaterfallLayoutDelegate <NSObject>
...
@interface HorizWaterfallLayout : UICollectionViewLayout
...
//代理，用来计算item的高度
@property (nonatomic, weak) id<HorWaterfallLayoutDelegate> delegate;
